    ...
    return (
        <main className=''>
            ...
            <h4 className='text-center m-4 my-2  text-sm'>
              <span>You can share the link with your friends Limited to <strong>5 links per 24.</strong></span>
            </h4>
            <h4 className='text-center m-4 my-2  text-sm'>
              <strong>Save your link and share</strong> it with your friends must be with <a className="text-blue-500 hover:underline" href="/auth/login"> Login required </a>
            </h4>
