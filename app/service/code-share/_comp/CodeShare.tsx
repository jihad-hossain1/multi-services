        ...
        <div className='flex flex-col gap-5'>
            ...
            <div className='flex flex-col gap-2 items-center relative'>
                <button
                    ...
                    className='w-fit flex gap-2 items-center text-violet-50 bg-violet-800 rounded-md shadow hover:shadow-lg py-2 px-5'
                >
                    {loading ? (
                        <Image
                            src={spanning}
                ...
                {path == "/profile" ? (
                    <>
                        {errors?.length > 0 ? 
                            <div className={errors?.length > 0 ? "absolute top-0 right-0 z-20 " : "hidden"}>
                             {
                               errors?.map((error: string, index: number) => (
                                <div key={index} className="shadow-[0_0_10px_rgba(0,0,0,0.1)] bg-red-100 p-4 rounded">
